...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">ANAND KUMAR PATEL
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate sapiente debitis optio earum deserunt ex veniam cupiditate id. Consequatur corporis, ipsa facere fuga odio magni cum vero laudantium deserunt eveniet.</p>

            <a href="#contact" id="contact" className="button button--flex">Say Hello
                <svg
